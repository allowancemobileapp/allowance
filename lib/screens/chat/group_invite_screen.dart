...
class _GroupInviteScreenState extends State<GroupInviteScreen> {
  ...
  Future<void> _loadGroupPreview() async {
    ...
    try {
      final result = await supabase.rpc('get_group_invite_preview',
          params: {'p_chat_id': widget.chatId}).maybeSingle();
      ...
      setState(() {
        _chat = {
          ...
          'group_avatar': result['group_avatar'],
